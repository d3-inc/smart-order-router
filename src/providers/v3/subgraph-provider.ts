...
const SUBGRAPH_URL_BY_CHAIN: { [chainId in ChainId]?: string } = {
  ...
  [ChainId.DOMA_SEPOLIA]: 'https://graph-devnet.doma.xyz/subgraphs/name/uniswap-v3-doma-testnet',
  [ChainId.DOMA]: 'https://graph.doma.xyz/subgraphs/name/uniswap-v3-doma-mainnet',
};
